...
public class UploadFileListAdapter extends BaseAdapter
{
	...
	public UploadFileListAdapter (Context context, List<String> it, List<String> pa)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		if(convertView == null)
		{
			convertView = mInflater.inflate(R.layout.row_uploadfile, null);
			holder = new ViewHolder();
			holder.iv_showFileImage = (ImageView)convertView.findViewById(R.id.iv_row_upload_showFileImage);
			holder.tv_fileName = (TextView)convertView.findViewById(R.id.tv_row_upload_showFileName);
